DROP TABLE ipregister CASCADE CONSTRAINTS;
...
CREATE TABLE notice(
		...
		n_image                       		VARCHAR2(100)		 NULL ,
		n_groupno                     		NUMBER(10)		 NULL ,
		n_step                        		NUMBER(10)		 NULL ,
		n_depth                       		NUMBER(10)		 NULL 
);
...
CREATE TABLE ipregister(
		i_no                          		NUMBER(10)		 NULL ,
		i_name                        		VARCHAR2(50)		 NULL ,
		i_ipno                        		VARCHAR2(50)		 NULL ,
		u_id                          		VARCHAR2(50)		 NULL ,
		i_date                        		DATE		 DEFAULT sysdate		 NULL 
);

DROP SEQUENCE ipregister_i_no_SEQ;

CREATE SEQUENCE ipregister_i_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;
...
ALTER TABLE QNA ADD CONSTRAINT IDX_QNA_FK0 FOREIGN KEY (u_id) REFERENCES userinfo (u_id) on delete set null;
...
ALTER TABLE orderdetail ADD CONSTRAINT IDX_orderdetail_FK1 FOREIGN KEY (b_no) REFERENCES book (b_no) on delete cascade;
...
ALTER TABLE cart ADD CONSTRAINT IDX_cart_FK1 FOREIGN KEY (b_no) REFERENCES book (b_no) on delete cascade;

ALTER TABLE ebook ADD CONSTRAINT IDX_ebook_PK PRIMARY KEY (e_no);
ALTER TABLE ebook ADD CONSTRAINT IDX_ebook_FK0 FOREIGN KEY (b_no) REFERENCES book (b_no) on delete cascade;

ALTER TABLE eorder ADD CONSTRAINT IDX_eorder_PK PRIMARY KEY (eo_no);
ALTER TABLE eorder ADD CONSTRAINT IDX_eorder_FK0 FOREIGN KEY (e_no) REFERENCES ebook (e_no) on delete cascade;
ALTER TABLE eorder ADD CONSTRAINT IDX_eorder_FK1 FOREIGN KEY (u_id) REFERENCES userinfo (u_id) on delete cascade;

ALTER TABLE ipregister ADD CONSTRAINT IDX_ipregister_PK PRIMARY KEY (i_no);
ALTER TABLE ipregister ADD CONSTRAINT IDX_ipregister_FK0 FOREIGN KEY (u_id) REFERENCES userinfo (u_id) on delete cascade;
