...
public class EbookSQL {
	public static final String INSERT = "insert into eorder values(seq.nextval, sysdate, sysdate+90,?, ?)";
	public static final String UPDATE = "update eorder set eo_date_end = eo_date_end+90 where eo_no=? and u_id =?";
	public static final String DELETE = "delete eorder where eo_no=? and u_id=?";
